  ...
  return (
    ...
    <div className='flex justify-between items-baseline'>
        ...
        <div className='flex items-baseline mb-2'>
            <input className='w-14 h-8 mr-2 border border-gray-200 text-center' 
                type='number'
    ...
    <div className='relative z-0 w-full flex items-center'>
        <input className='w-full h-[2px] bg-gray-300 rounded-lg appearance-none cursor-pointer'
            type="range" 
        ...
        <div className='absolute -z-10 top-1/2 left-1/2 -translate-y-1/2
                        -translate-x-1/2 w-0.5 h-10 bg-gray-300 rounded'></div>
    </div>
</div>
)
}
